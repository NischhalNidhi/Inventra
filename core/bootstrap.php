...
require_once __DIR__ . '/../dev1/models/Category.php';
require_once __DIR__ . '/../dev3/models/Supplier.php';
require_once __DIR__ . '/../dev1/models/Product.php';
...
require_once __DIR__ . '/../dev1/controllers/categoryController.php';
require_once __DIR__ . '/../dev3/controllers/supplierController.php';
require_once __DIR__ . '/../dev1/controllers/productController.php';
