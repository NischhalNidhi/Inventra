...
<section class="panel">
    <form method="post" action="<?= e(basePath('index.php?page=reports')); ?>" class="form-grid">
        ...
        <label><span>Quantity to Add</span><input type="number" name="quantity" min="1" required></label>
        <label><span>Date</span><input type="date" name="date" value="<?= e(date('Y-m-d')); ?>"></label>
        <label class="wide"><span>Reason / Reference</span><input type="text" name="reason" placeholder="e.g. Manual count correction, returned item..."></label>
